namespace Assignment02
{
    public class AssignmentConfig
    {
        ...
        /// </summary>  
        public const string AssignmentName = "Assignment 04";

        /// <summary>
        /// Description of the assignment.
        /// </summary>
        public const string AssignmentDescription = "Introduction to LinkedList, Dictionary, and HashSet in C# with Unity";

        public const string AssignmentResourceID = "bu.2025.sem-1.gi262.as04";
